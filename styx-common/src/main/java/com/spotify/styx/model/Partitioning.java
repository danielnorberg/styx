...
public abstract class Partitioning {
  ...
  public static final Partitioning HOURS = parse("@hourly");
  public static final Partitioning DAYS = parse("@daily");
  public static final Partitioning WEEKS = parse("@weekly");
  public static final Partitioning MONTHS = parse("@monthly");
  public static final Partitioning YEARS = parse("@yearly");
  ...
  @JsonCreator
  public static Partitioning parse(String expression) {
    ...
    return new AutoValue_Partitioning(normalizedExpression);
  }
