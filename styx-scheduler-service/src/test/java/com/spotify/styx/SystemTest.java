...
public class SystemTest extends StyxSchedulerServiceFixture {
  ...
  private static final DataEndpoint DATA_ENDPOINT_HOURLY = DataEndpoint.create(
      "styx.TestEndpoint", Partitioning.HOURS, empty(), of("busybox"), of(asList("--hour", "{}")),
      empty(), emptyList());
  private static final DataEndpoint DATA_ENDPOINT_DAILY = DataEndpoint.create(
      "styx.TestEndpoint", Partitioning.DAYS, empty(), of("busybox"), of(asList("--hour", "{}")),
      empty(), emptyList());
  ...
  public void retriesUseLatestWorkflowSpecification() throws Exception {
    ...
    DataEndpoint changedDataEndpoint = DataEndpoint.create(
        DATA_ENDPOINT_HOURLY.id(), Partitioning.HOURS, empty(), of("busybox:v777"),
